...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/clarivue-interview-dashboard-9x5i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/clarivue-interview-dashboard-9x5i/settings/integrations/github)
