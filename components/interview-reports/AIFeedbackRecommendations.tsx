...
export function AIFeedbackRecommendations({ summary, recommendations, technicalFeedback }: AIFeedbackRecommendationsProps) {
  return (
    <div className="bg-linear-to-br from-[#C8A0FE]/10 via-white to-[#B8CCF4]/10 rounded-xl p-5 border border-[#C8A0FE]/20">
      <div className="flex items-center gap-3 mb-4">
        <div className={`w-10 h-10 rounded-full bg-linear-to-br ${gradients.secondary} flex items-center justify-center`}>
      ...
      {technicalFeedback && (
        <div className="mb-6 p-4 bg-linear-to-r from-blue-50 to-indigo-50 dark:from-blue-950 dark:to-indigo-950 rounded-lg border border-blue-200 dark:border-blue-800">
      ...
      <div className="space-y-3">
        ...
        {recommendations.map((rec, index) => (
          ...
          >
            <div className={`w-6 h-6 rounded-full bg-linear-to-br ${gradients.tertiary} flex items-center justify-center flex-shrink-0 text-white text-xs font-bold group-hover:scale-110 transition-transform`}>
              {index + 1}
            </div>
