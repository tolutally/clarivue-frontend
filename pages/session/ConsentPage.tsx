...
export function ConsentPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // For now, just navigate - in the future, we might want to save consent to API
                ...
                <div className="space-y-6">
                  <div className="space-y-4">
                    <div className="flex items-start gap-3 pb-3 border-b border-slate-200">
                      <Video className="w-5 h-5 text-blue-600 shrink-0 mt-1" aria-hidden="true" />
                    ...
                    <div className="flex items-start gap-3 pb-3 border-b border-slate-200">
                      <Users className="w-5 h-5 text-blue-600 shrink-0 mt-1" aria-hidden="true" />
                      <div className="flex-1">
                        <h3 className="font-semibold text-slate-900 mb-2">
                          Who Sees Your Data
                        </h3>
                    ...
                    <div className="flex items-start gap-3">
                      <Database className="w-5 h-5 text-blue-600 shrink-0 mt-1" aria-hidden="true" />
                      <div className="flex-1">
                        <h3 className="font-semibold text-slate-900 mb-2">
                          Data Retention
                        </h3>
                  ...
                  <div className="border-t border-slate-200 pt-6 space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p id="recordingConsent-description" className="text-sm text-slate-600 mt-1">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p id="dataUsageConsent-description" className="text-sm text-slate-600 mt-1">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p id="researchConsent-description" className="text-sm text-slate-600 mt-1">
