 ...
 * ConsentPage
 * 
 * Route: /session/:sessionId/consent
 * 
 * Purpose: Privacy policy and data consent collection.
 * Adapted from legacy mockinterviews/ConsentPage with new session-based routing.
 */
export function ConsentPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await backend.interviews.submitConsent(sessionId, {
        consentGiven: true,
        dataProcessingConsent: consents.dataUsageConsent,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      <InterviewHeader currentStep={3} totalSteps={7} stepLabel="Privacy & Consent" />
